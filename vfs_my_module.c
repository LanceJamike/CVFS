...
static const char *sharevolume(vfs_handle_struct *handle)
{
	...
	tmp_str = lp_parm_const_string(SNUM(handle->conn), "vfs_my_module", "lpath","/mnt/LinearLV");
...
static const char *stripevolume(vfs_handle_struct *handle)
{
	...
	tmp_str = lp_parm_const_string(SNUM(handle->conn), "vfs_my_module", "spath","/mnt/StripeLV");
